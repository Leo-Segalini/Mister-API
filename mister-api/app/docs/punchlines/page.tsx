...
import { BookOpen, Code, Zap, Shield, ArrowRight, Copy, Check, ChevronDown, ChevronUp, Settings, Database } from 'lucide-react';
...
export default function PunchlinesDocs() {
  ...
  const codeExamples = [
    {
      id: 'basic',
      title: 'Récupération basique',
      description: 'Récupérez des punchlines avec pagination',
      code: `curl -X GET "http://localhost:3001/api/v1/punchlines" \\
  -H "x-api-key: votre_clé_api"`,
      response: {
        ...
        data: {
          punchlines: [
            {
              id: "1550455d-5f2c-49f9-a854-309f1b4337d6",
              citation: "La liberté consiste à pouvoir faire tout ce qui ne nuit pas à autrui.",
              auteur: "Déclaration des Droits de l'Homme",
              theme: "Politique",
              tags: ["liberté", "droits", "révolution"],
              source_film: false,
              source_livre: true,
              annee: "1789",
              langue: "France",
    ...
    {
      id: 'theme',
      title: 'Filtrage par thème',
      description: 'Récupérez des punchlines d\'un thème spécifique',
      code: `curl -X GET "http://localhost:3001/api/v1/punchlines?theme=Philosophie" \\
  -H "x-api-key: votre_clé_api"`,
      response: {
        success: true,
        message: "Citations historiques récupérées avec succès",
        data: {
          punchlines: [
            {
              id: "a2d4672a-2287-4d4e-bb4b-c762d4bd4664",
              citation: "Connais-toi toi-même.",
              auteur: "Socrate",
              theme: "Philosophie",
              tags: ["sagesse", "connaissance", "antiquité"],
              source_film: false,
              source_livre: true,
              annee: "-400",
              langue: "Grèce",
    ...
    },
    {
      ...
      description: 'Recherchez des punchlines par auteur',
      code: `curl -X GET "http://localhost:3001/api/v1/punchlines?search=Déclaration" \\
  -H "x-api-key: votre_clé_api"`,
      response: {
        success: true,
        message: "Citations historiques récupérées avec succès",
  ...
  const features = [
    {
      ...
      description: 'Récupérez des punchlines en quelques millisecondes'
    },
    {
      icon: <Shield className="h-6 w-6" />,
      title: 'Contenu sécurisé',
      description: 'Toutes les punchlines sont modérées et appropriées'
    },
    {
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              L'API Punchlines vous permet d'accéder à une collection de citations historiques 
              classées par thèmes et auteurs, parfaites pour enrichir vos projets.
            </p>
            <div className="bg-gray-800 rounded-lg p-4">
              <h5 className="font-medium text-white mb-2">Endpoint de base</h5>
              <code className="text-green-400 text-sm">GET /api/v1/punchlines</code>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-gray-300 text-sm mt-1">Recherche dans les citations et auteurs</p>
              </div>
              <div>
                <code className="text-green-400">theme</code>
                <p className="text-gray-300 text-sm mt-1">Filtrage par thème</p>
              </div>
              <div>
                <code className="text-green-400">auteur</code>
                <p className="text-gray-300 text-sm mt-1">Filtrage par auteur</p>
              </div>
              <div>
                <code className="text-green-400">annee</code>
                <p className="text-gray-300 text-sm mt-1">Filtrage par année</p>
              </div>
              <div>
                <code className="text-green-400">langue</code>
                <p className="text-gray-300 text-sm mt-1">Filtrage par langue</p>
              </div>
              <div>
        ...
        <div className="space-y-4">
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                <code className="text-green-400">data.punchlines</code>
                <p className="text-gray-300 text-sm mt-1">Tableau des citations</p>
              </div>
              <div>
                <code className="text-green-400">data.total</code>
                <p className="text-gray-300 text-sm mt-1">Nombre total de citations</p>
              </div>
              <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center mb-6">
              <BookOpen className="h-12 w-12 text-green-400 mr-4" />
              <h1 className="text-4xl md:text-5xl font-bold">API Punchlines</h1>
            </div>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Générez des punchlines créatives pour vos projets humoristiques. 
              Une collection de milliers de punchlines classées par thèmes et auteurs.
            </p>
          </motion.div>
